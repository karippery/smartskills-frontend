    ...
    <footer className="bg-primary-900 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Branding Section */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-primary-300">Smart Skills</h3>
            <p className="text-primary-100">
              Empowering your learning journey with cutting-edge skills development.
            </p>
          </div>
          ...
          {/* Social Media Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-primary-500">Connect</h4>
            <div className="flex space-x-4">
              ...
              {/* Twitter Icon */}
              <a href="#" className="text-primary-100 hover:text-white transition-colors" aria-label="Twitter">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 
                    ...
                    012.8 9.713v.052a4.105 4.105 0 003.292 
              ...
              <a href="#" className="text-primary-100 hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path
                    ...
                    2.427.465a4.902 4.902 0 011.772 1.153 4.902 4.902 
                    ...
                    2.525c.636-.247 1.363-.416 2.427-.465C8.901 2.013 9.256 2 
                    ...
                    6.865a5.135 5.135 0 110 10.27 5.135 5.135 
                    0 010-10.27zm0 1.802a3.333 3.333 0 100 
        ...
        <div className="border-t border-primary-700 mt-8 pt-6 text-center text-primary-300">
          <p>© {new Date().getFullYear()} Smart Skills. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
